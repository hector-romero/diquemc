...
$txt['install_mod'] = 'Instalar Mod';
$txt['uninstall_mod'] = 'Desinstalar mod';
...
$txt['package_manager_desc'] = 'Desde el gestor de paquetes puedes descargar e instalar modificaciones a tu foro a través de una interfaz fácil de usar.';
...
$txt['add_languages'] = 'Agregar Lenguaje';
...
$txt['corrupt_compatible'] = 'El paquete que estás tratando de bajar o instalar está corrupto o no es compatible con tu versión de SMF.';
...
$txt['package_will_fail_warning'] = 'Se ha encontrado algún error durante la prueba de la instalación de este paquete.
	Es <b>altamente</b> recomendado que no continues la instalación a menos que sepas lo que estás haciendo, y hayas realizado una copia de seguridad muy recientemente.
	Este error puede haber sido causado por un conflicto entre el paquete que estés intentando instalar y otro paquete que ya has instalado, un error en el paquete, un paquete que requiere otro paquete que no has instalado aún, o un paquete diseñado para otra versión de SMF.';
...
$txt['package_will_fail_popup_uninstall'] = 'Estas seguro que quieres continuar desinstalando esta modificacion, aunque no se desinstalara correctamente?';
...
$txt['package_other_themes_uninstall'] = 'Desinstalar en otros Themes';
$txt['package_other_themes_desc'] = 'Para usar esta modificacion en otros temas aparte del predeterminado, el manager de paquetes tiene que hacer cambios adicionales a los otros temas. If you\'d like to install this modification in the other themes, please select these themes below.';
// Don't use entities in the below string.
...
$txt['package_ftp_test'] = 'Prueba';
$txt['package_ftp_test_connection'] = 'Prueba de Conección';
...
$txt['package_db_uninstall'] = 'Remover todos los datos asociados con esta modificación.';
$txt['package_db_uninstall_details'] = 'Detalles';
$txt['package_db_uninstall_actions'] = 'Marcar esta opción provocará en los siguientes cambios en la base de datos';
...
$txt['package_emulate'] = 'Emular Version';
$txt['package_emulate_revert'] = 'Revertir';
$txt['package_emulate_desc'] = 'Algunas veces los paquetes están bloqueados para versiones anteriores de SMF pero continuan siendo compatibles con versiones nuevas. Aquí puedes elegir "emular" una versión diferente de SMF dentro del manejador de paquetes.';
...
$txt['package_file_perms_predefined_note'] = 'Nota que esto solo se aplica al perfil predefinido de las carpetas y archivos clave de SMF.';
...
$txt['package_file_perms_ftp_retain'] = 'SMF solo retendrá la contraseña temporalmente para facilitar la operación del manejador de paquetes.';
...
$txt['package_restore_permissions'] = 'Restaurar Permisos del Archivo';
$txt['package_restore_permissions_desc'] = 'Los siguientes permisos de archivo han sido cambiados por SMF para instalar el o los paquetes seleccionados. Puedes volver al estado anterior los permisos de estos archivos haciendo click en "Restaurar". ';
...
$txt['package_restore_permissions_action_success'] = '<span style="color: green;">Exitoso</span>  ';
$txt['package_restore_permissions_action_failure'] = '<span class="error">Fallido</span>';
$txt['package_restore_permissions_action_done'] = 'SMF ha intentado restaurar los archivos seleccionados a su estado de permisos original, los resultados aparecen a continuación. Si un cambio falló, o para una vista mas detallada de los permisos, por favor revisa la sección <a href="%1$s">Permisos de Archivo</a>';

$txt['package_file_perms_warning'] = 'Por favor Nota';
$txt['package_file_perms_warning_desc'] = '<li>Se cuidadoso cuando cambies los permisos de archivo desde esta sección - los permisos incorrectos puede afectar adversamente la operación de tu foro</li> <li>En algunos servidores la selección de permisos incorrectos podría detener el funcionamiento de SMF.</li> <li>Ciertos directorios como <i>attachments</i> necesitan ser modificables para poder ser usar esa funcionalidad.</li> <li>Esta función es principalmente aplicable en servidores no basados en Windows - no funcionará como se espera en Windows en lo referido a permisos.</li> <li>Antes de proceder asegúrate que tienes un cliente de FTP instalado para acceder al servidor via FTP en caso de cometer un error y necesitar ingresar para remediarlo.</li>';
